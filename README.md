...
## Installation
In order to use the tool you need a working python environment. 
### Other requirements
* streamlit
* numpy
* scipy
...
If you use this toolkit in your research, please consider citing the following paper:

Foroughi, Farangis, et al. "A Gaussian fitting-based analysis method for multiple image radiography with integrated angular calibration, MIR2." Physics in Medicine & Biology 70.23 (2025): 235032.
...
2. Review the silicon diffraction tabs if needed
3. Open the MIR2 Analysis tab
4. Load the dark, reference, and object image stacks
5. Define the crop ROI and calibration box
6. Choose the rocking-curve source: internal silicon-model rocking curve or uploaded external rocking curve
7. Set experiment and fitting parameters
8. Run the MIR2 analysis
9. Inspect and save the results
...
>>>>>>> a50fa8e54c7b3903fda09c4ff2c3651021443a63
